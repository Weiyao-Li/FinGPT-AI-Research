...
deepspeed -i "localhost:${gpu_idx}" train_lora.py --run_name ${run_name} --base_model ${base_name} --dataset data/fingpt-sentiment-train --max_length 512 --batch_size 4 --learning_rate 2e-4 --num_epochs 8 --from_remote False
