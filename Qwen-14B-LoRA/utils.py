...
lora_module_dict = {
    ...
    'internlm-20b': ['q_proj', 'k_proj', 'v_proj'],
...
def parse_model_name(name, from_remote=False):
    ...
    if name == 'chatglm2':
        ...
        return 'meta-llama/Llama-2-13b-hf' if from_remote else 'base_models/Llama-2-13b-hf'
    elif name == 'falcon':
    ...
    elif name == 'internlm-20b':
        return 'internlm/internlm-20b' if from_remote else 'base_models/internlm-20b'
    elif name == 'qwen':
        ...
        return 'baichuan-inc/Baichuan2-7B-Base' if from_remote else 'base_models/Baichuan2-7B-Base'
    elif name == 'Qwen':
        return 'Qwen/Qwen-14B' if from_remote else 'base_models/Qwen-14B'
    else:
...
def load_dataset(names, from_remote=False):
    ...
    for name in dataset_names:
        ...
        tmp_dataset = datasets.load_from_disk(name)['train']
